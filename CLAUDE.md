...
- `pick_local_file(title?)` / `pick_save_location(defaultName?)` → `string | null`: backend-opened native dialogs; the chosen path is recorded as usable for file I/O
